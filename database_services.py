...
#manager.create_table('requests', ['category', 'user_id', 'text_of_request'], ['text', 'text', 'text'])
'''
manager.clear_table('requests')
manager.add_row('requests', ['1', '1', 'hjfdhfjdhf'])
manager.add_row('requests', ['1', '12', 'gfdgfdfg'])
manager.add_row('requests', ['1', '123', 'sdff'])
manager.add_row('requests', ['2', '3', 'gff'])
manager.add_row('requests', ['2', '32', 'hggsseeq'])
manager.add_row('requests', ['2', '321', 'das'])
manager.add_row('requests', ['3', '35', 'fdfgjkdskl'])
manager.add_row('requests', ['3', '35322', 'hggsskjhhjhjeeq'])
manager.add_row('requests', ['3', '32541', 'daddfgdfgdfgs'])
